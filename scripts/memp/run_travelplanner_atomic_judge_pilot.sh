...
CANDIDATES="${ROOT}/data/memp_ncf/travelplanner_atomic_memory_candidates_v1/judge_pilot30.jsonl"
OUTPUT="${ROOT}/data/memp_ncf/travelplanner_atomic_memory_judge_pilot30_v1"
