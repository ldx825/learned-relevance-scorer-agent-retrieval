...
RESULTS="$ROOT/.runtime/memp/travelplanner/atomic_cosine_validation10/results"
RETRIEVAL="$ROOT/data/memp_ncf/travelplanner_atomic_dynamic_validation10/cosine_retrieval.json"
...
"$PYTHON" "$ROOT/scripts/memp/evaluate_travelplanner_validation_slice.py" \
  ...
  --output "$ROOT/.runtime/memp/travelplanner/atomic_cosine_validation10/evaluation.json"
